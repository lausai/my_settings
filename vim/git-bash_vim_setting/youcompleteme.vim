...
# When running vim in git-bash, the path is /c/... format, it is not work
# and will see error: ycm module not found, so manually set the path here
root_folder = "C:\\Users\\02569\\.vim\\bundle\\YouCompleteMe"
